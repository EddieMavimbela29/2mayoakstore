...
export default function AdminInstitutionEditScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`/api/admin/institutions/${productId}`);
  ...
  const submitHandler = async ({
    ...
    try {
      ...
      await axios.put(`/api/admin/institutions/${productId}`, {
        name,
        slug,
        price,
        province,
        ...
        <div className="md:col-span-3">
          {loading ? (
            ...
            >
              ...
              <div className="mb-4">
                <label htmlFor="price">Application Price</label>
                <input
                  type="text"
                  className="w-full"
                  id="price"
              ...
              <div className="mb-4">
                <Link href={`/admin/institutions`}>Back</Link>
              </div>
            </form>
          )}
        </div>
